   ...
   <a-sound id="audio-2"
      ...
      animation__one="property: rotation;to: 0 360 0; dur: 2000;easing:easeInOutCirc;fill:forwards;repeat:0.5;loop:0;enabled:false"  >
            <a-entity id="CamEntity">
              ...
              <a-entity id="cursor" cursor="fuse: true; fuseTimeout: 1200" geometry="primitive: ring; radiusInner: 0.02; radiusOuter: 0.03"	material="color: red; shader: flat" raycaster="objects: .clickable" position="0 0 -1" sky scale="1 1 1">
