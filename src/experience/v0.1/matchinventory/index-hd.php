...
<body>
  ...
  <a-scene id="sceneid" embeded shadow="type:pcfsoft" antialias="true" loading-screen="enabled:false">
    ...
    <!-- <a-box id="InventoryHotspot" material="src:/act/v0.1/matchinventory/assets/images/icons/inventory.png;transparent:true" geometry="height:4;width:4" shader="flat" class="clickable" shadow="" set-sky="" position="4.029012210513073 10.919892350737697 -23.86899621184311" look-at="src:#mainCam" visible="" rotation="23.843025317992378 -10.494023079874122 4.602023418293656"></a-box> -->
    ...
    <a-plane id="mainInfo" material="side:back;opacity:0;transparent:true" visible="false" look-at="src: #mainCam"
      ...
      <!-- <a-animation attribute="scale" dur="2000" fill="forwards" from="0 0 0" to="2.2 2.2 1"
        begin="startAnimationpanel"></a-animation>
      <a-animation attribute="scale" dur="2000" fill="forwards" from="2.2 2.2 1" to="0 0 0" begin="endAnimation">
      </a-animation> -->
      <!-- <a-animation attribute="position" dur="1000" fill="forwards"  to="2000 2000 2000" begin="endAnimationPosition"></a-animation> -->
    ...
    <!-- <a-plane id="panelScreen" material="side:back;opacity:0;transparent:true" visible="false" look-at="src: #mainCam"
      geometry="height:7;width:19" position="2000 2000 2000" scale="1.4 1.4 0">
      <a-plane id="scoreScreen" color="#000000" material="side:double;opacity:0.8;transparent:true" visible="true"
        look-at="src: #mainCam" geometry="height:7;width:19" position="0 0 0" scale="0 0 0">
        <a-animation attribute="scale" dur="2000" fill="forwards" from="0 0  0" to="1.4 1.4 0" begin="score">
        </a-animation>
        <a-animation attribute="scale" dur="2000" fill="forwards" to="0 0  0" from="1.4 1.4 0" begin="closeAnimation">
        </a-animation>
      </a-plane>
      <a-plane id="scoreScreen2" material="side:double;opacity:0;transparent:true" visible="true"
        geometry="height:12;width:18" look-at="src: #mainCam" position="0 0 500" scale="0 0 0">
        <a-animation attribute="scale" dur="2000" fill="forwards" from="0 0 0" to="1.4 1.5 0" begin="score1">
        </a-animation>
        <a-animation attribute="scale" dur="2000" fill="forwards" to="0 0  0" from="1.4 1.4 0" begin="closeAnimation1">
        </a-animation>
