...
-->
    ...
    <link rel="stylesheet" href="/act/v0.1/showandtell/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="/act/v0.1/showandtell/assets/css/sidebarinner.css">
     <link rel="stylesheet" href="/act/v0.1/verbose/css/SplashScreenToogleButton.css">
    <link rel="stylesheet" href="/act/v0.1/showandtell/assets/css/show&tell.css">
    <link rel="stylesheet" href="/act/v0.1/showandtell/assets/css/fa-v5.css">
    <link rel="stylesheet" href="/act/v0.1/verbose/splash.css">
    
    <script src="/act/v0.1/showandtell/assets/js/jquery-3.3.1.min.js"></script>
    ...
    <script src="/act/v0.1/showandtell/assets/js/position.js"></script>
...
<div id="loaderq" class="lds-roller lds-roller-pos-assets-popup" style="position: absolute; z-index: 9999"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>
    <div id="container" class="container">
      ...
      <a-scene id="sceneid" light="defaultLightsEnabled: false" antialias="true" loading-screen="enabled:false">
                            <a-assets id="assets">
                                <img id="office" crossorigin="anonymous">
                                <a-asset-item id="audioAsset" preload="auto" crossorigin="anonymous" src="/act/v0.1/showandtell/assets/audio/Work Ethics.mp3" response-type="arraybuffer"></a-asset-item>
                                <!-- <audio id="audioAsset" preload="auto" crossorigin="anonymous" src="/act/v0.1/showandtell/assets/audio/Work Ethics.mp3"></audio> -->
                            ...
                            <a-entity id="CamEntity">
                              <!-- <a-entity id="mainCam" camera position="0 1.6 0" look-controls wasd-controls-enabled="false" rotation="0 0 0"> -->
                              <a-entity id="mainCam" camera look-controls="reverseTouchDrag:true" rotation="1.031 108.862 0">
                      
                                <a-entity id="cursor" cursor="fuse: true; fuseTimeout: 1200" raycaster="objects: .clickable" position="0 0 -1"
                                  sky scale="1 1 1" geometry="primitive: ring; radiusInner: 0.02; radiusOuter: 0.03"
                                  material="color: red; shader: flat">
                      
                                  <!-- <a-entity id="cursorImage" svgfile="svgFile:assets/images/viewfinder.svg; width:0.012;opacity:1; "   position="-0.054 0.044 -0.014" material="shader: flat;"  light="type:ambient;intensity:1.71" scale="1 1 1"></a-entity> -->
                                </a-entity>
                              </a-entity>
                            </a-entity>
                          </a-entity>
                            <a-sphere id="main-bg" radius="20" position="0 1.6 0" rotation="0 90 0" color="#333" material="side: double;opacity:0"></a-sphere>
                            <a-entity id="audioEntity" sound="src: #audioAsset"></a-entity>
                        </a-scene>
