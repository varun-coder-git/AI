...
<body class="" id='mainBody' style='margin : 0px; overflow: hidden !important;'>
      ...
      <div class="inner-overloy hidden-login" style="overflow-y: auto" id="innerInfo">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 border-left">
            ...
            <div class="row">
              <div class="col-9"></div>
              <div class="col-3" class="" style="text-align: center">
                <a>
                <div id=""
                 onclick="printMarker()"
  ...
  <div class="inactiveMessage" id="myDiv">This Experience is no longer Active in this room.</div>
    <a-scene id="sceneid" embedded arjs=' sourceType: webcam;debugUIEnabled: false; ' renderer="precision: mediump" sourceWidth:1280; sourceHeight:960; displayWidth: 1280; displayHeight: 960;>
      <a-assets id="assetId"> 
        <img id="img" src="">
      </a-assets> 
