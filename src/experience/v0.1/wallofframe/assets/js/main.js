...
function loadExperience(museumData, ExperienceName) {
  ...
  for (i = 1; i <= museum_data.gallery_data.length; i++) {
    ...
    changedgallery.setAttribute(
      "src",
      museum_data.gallery_data[i - 1].image_path
    );
    ...
    textview.setAttribute(
      "value",
      museum_data.gallery_data[i - 1].image_description
    );
  }
  ...
  floortexture.setAttribute(
    "material",
    "src: /act/v0.1/wallofframe/assets/textures/" +
      museum_data.decore_option +
      "-floor.jpg"
  );
