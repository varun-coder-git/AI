    ...
    this.el.addEventListener('click', () => {
      if (experienceStarted == true) {
        ...
        if (storypointsdata.actionPoints[mediatype[1] - 1].actionSize === "small") {
          background.emit("imgPlaneStartAnimation");
        } else if (storypointsdata.actionPoints[mediatype[1] - 1].actionSize === "medium") {
          background.emit("imgPlaneStartAnimationMedium");
        } else {
          background.emit("imgPlaneStartAnimationLarge");
        }
        var obj = 'Marker';
        for (i = 1; i <= storypointsdata.actionPoints.length; i++) {
        ...
        for (i = 1; i <= storypointsdata.actionPoints.length; i++) {
          ...
          if (background != backgroundData) {
            ...
            aimgPlaneStartAnimationHide = document.createElement('a-animation');
            aimgPlaneStartAnimationHide.setAttribute('attribute', "scale");
            aimgPlaneStartAnimationHide.setAttribute('dur', "1500");
            aimgPlaneStartAnimationHide.setAttribute('fill', "forwards");
            aimgPlaneStartAnimationHide.setAttribute('to', "0 0 0");
            aimgPlaneStartAnimationHide.setAttribute('begin', "imgPlaneStartAnimationHide");
            backgroundData.appendChild(aimgPlaneStartAnimationHide);
            backgroundData.emit("imgPlaneStartAnimationHide");
          }
        }
        switch (mediatype[0]) {
          case 'V':
