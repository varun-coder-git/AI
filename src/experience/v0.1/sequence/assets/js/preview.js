  ...
  function initializePreview(experienceJSON, ExperienceName) {
    ...
    storypointsdata = JSON.parse(experienceJSON);
    $("#loaderq").addClass("hidden-login");
    $("#innerInfo").removeClass("hidden-login");

    var instructionSet = storypointsdata.splash_instruction;;
    var lunchTextSet = storypointsdata.launch_text;
    ...
    loadExperience(storypointsdata);
  ...
  function loadExperience(storypointsdata) {
          ...
          switch (mediatype[0]) {
            ...
            case 'VT':
              ...
              var videoSphere = document.querySelector('#videoskyid');
                  ...
                  text.setAttribute("text","value", storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointHeader);
                  var text1 = document.getElementById('text2');
                  text1.setAttribute("text","value", storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointText);
                  if(storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointColor){
                    text1.setAttribute("text","color",storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointColor);
                    text.setAttribute("text","color",storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointColor);
                  }else{
            ...
            case 'AT':
              var textAnimation = document.getElementById('textAnimation');
                  if(storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointAudio!=""){
                  var ua = navigator.userAgent.toLowerCase(); 
                  if (ua.indexOf('safari') != -1) { 
                    if (ua.indexOf('chrome') ==-1 ) {
                        var audio1 = document.getElementById('audio1');
                    ...
                    if(videoSphere){
                      ...
                      text1.setAttribute("text","value", storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointHeader);
                      var text = document.getElementById('text2');
                      text.setAttribute("text","value", storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointText);
                      if(storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointColor){
                        text1.setAttribute("text","color",storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointColor);
                        text.setAttribute("text","color",storypointsdata.actionPoints[parseInt(mediatype[1]) - 1].actionPointColor);
                      }else{
