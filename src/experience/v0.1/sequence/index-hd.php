...
-->
  ...
  <script src="/act/v0.1/sequence/assets/js/jquery-3.3.1.min.js"></script>
  <script src="/act/v0.1/sequence/assets/js/aframe-v1.0.4.min.js"></script>
  <link rel="stylesheet" href="/act/v0.1/sequence/assets/css/bootstrap.min.css">

  <link rel="stylesheet" href="/act/v0.1/verbose/css/SplashScreenToogleButton.css">
  <link rel="stylesheet" href="/act/v0.1/sequence/assets/css/fa-v5.css">
  <script src="/act/v0.1/sequence/assets/js/bootstrap.min.js"></script>
  <script src="/act/v0.1/sequence/assets/js/aframe-gif-shader.min.js"></script>
  <script src="/act/v0.1/sequence/assets/js/aframe-look-at-billboard-component.min.js"></script>
  <script src="/act/v0.1/sequence/assets/js/aframe-video-controls.min.js"></script>
  <script src="/act/v0.1/sequence/assets/js/aframe-vid-shader.min.js"></script>
...
<body class="" id='mainBody'>
  ...
  <a-scene id="sceneid" antialias="true" loading-screen="enabled:false">
    ...
    <a-assets id="assets">
      ...
      <video id="vid" src="" crossOrigin="anonymous" loop="true"
  ...
  <script src="/act/v0.1/sequence/assets/js/app.js"></script>
</body>
