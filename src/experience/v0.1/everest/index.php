...
-->
  ...
  <script src="assets/js/aframe1.0.4.min.js"></script>
...
<body class="" id='mainBody'>
  ...
  <a-scene id="sceneid" loading-screen="enabled:false">
    ...
    <a-assets id="assets">
      <img id="my-image"
        src="https://alpha-dev.experizer.com/api/images/assets/etkctfd3/periodic%20Table/periodic_Table1.jpg">
      <img id="office" src="">
      <audio id="sound" src="assets/audios/Work Ethics.mp3"></audio>
    ...
    <a-curvedimage id="quard1" src="" height="5" radius="6" theta-length="110" rotation="0 90 0" scale="30 50 30"
      material="" geometry="radius: 10; thetaLength: 110" visible="false">
    </a-curvedimage>
    ...
    <a-entity id="mainInfo" class="banner-entity" position="0.26152 6.39399 -20.49568" look-at="src: #mainCam"
      ...
      <a-plane id="textAnimation" color="#000000" material="side:double;opacity:0;transparent:true" height="20"
        scale="0 0 0" geometry="height:15;width:30" width="20" scale="" position="0 -1.9639 -10" visible=""
