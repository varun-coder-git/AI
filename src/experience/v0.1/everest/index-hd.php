...
-->
  ...
  <link rel="stylesheet" href="../verbose/splash.css">
  <script src="assets/js/jquery-3.3.1.min.js"></script>
  <script src="assets/js/aframev1.0.4.min.js"></script>
  <link rel="stylesheet" href="assets/css/bootstrap.min.css">
  <link rel="stylesheet" href="assets/css/fa-v5.css">
...
<body class="" id='mainBody'>
  ...
  <a-scene id="sceneid" antialias="true" loading-screen="enabled:false" loading-screen="enabled:false">
      ...
      <a-entity id="CamEntity">
        <a-entity id="mainCam" camera look-controls="reverseTouchDrag:true" wasd-controls-enabled="false"
          ...
          <a-entity id="cursor" cursor="fuse: true; fuseTimeout: 1200" raycaster="objects: .clickable" position="0 0 -1"
            ...
            <!-- <a-image id="cursorImage"  width="0.12" height="0.12" src="assets/images/viewfinder.png" material="shader: standard; depthTest: false" light="type:ambient;intensity:1.71" ></a-image> -->
          </a-entity>
        </a-entity>
      </a-entity>
    </a-entity>
    ...
    <a-assets id="assets">
      <img id="my-image" src="./assets/images/default.jpg">
      <img id="office" src="">
    ...
    <a-curvedimage id="quard1" src="" height="5" radius="6" theta-length="110" rotation="0 90 0" scale="30 50 30"
      material="" geometry="radius: 10; thetaLength: 110" visible="false"></a-curvedimage>
    <a-curvedimage id="quard2" src="" height="5" radius="6" theta-length="110" rotation="0 270 0" scale="30 50 30"
      material="" geometry="radius: 10; thetaLength: 110" visible="false"></a-curvedimage>
    ...
    <a-entity id="mainInfo" class="banner-entity" position="0.26152 6.39399 -20.49568" look-at="src: #mainCam"
      ...
      <a-plane id="textAnimation" scale="0 0 0" color="#000000" material="side:double;opacity:0;transparent:true"
        height="20" geometry="height:15;width:30" width="20" scale="" position="0 -1.9639 -10" visible=""
        ...
        <!-- <a-text id="text1" position="-13.86466 5.9 1.12607" text="width:28;baseline:top;wrapCount:48;lineHeight:50"
          value=""></a-text>
        <a-text id="text2" position="-13.86466 4.03 1.12607" text="width:28;baseline:top;wrapCount:48;lineHeight:50"
          value=""></a-text> -->
          <a-entity look-at="[camera]" id="text1" position="-0.08462 5.9 0.04179" material="metalness:1; roughness:0; transparent: true; opacity: .0; shader: flat;color: black; side:double;"
          text="font: https://cdn.aframe.io/fonts/Exo2Bold.fnt;width: 28; color: #fff; value: Want to learn about Frame? \n
      ...
      <a-plane id="videoframe" color="#fff" visible="false" geometry="height:16.88;width:30"
        ...
        <!-- <a-animation attribute="scale" dur="1500" fill="forwards" to="0.2 0.2 0.1" begin="startAnimationvide"></a-animation>
          <a-animation attribute="scale" dur="1500" fill="forwards" from="0.2 0.2 0.1" to="0 0 0" begin="endAnimation"></a-animation> -->
