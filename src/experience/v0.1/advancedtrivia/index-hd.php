...
<head>
  ...
  <meta name="description"
    content="A dedicated space for learning a topic with Placeholders for  relevant infographics on side walls and an interactive Trivia infront. Customize the theme and the walls as per the topic of your Trivia." />
  <meta name="keywords" content="" />

  <meta name="author" content="Media Quiz" />
  <meta name="copyright" content="studio.experizer.com" />
  <meta name="application-name" content="Experizer" />

  <!-- For Facebook -->
  <meta property="og:title" content="Media Quiz" />
  <meta property="og:type" content="article" />
  <meta property="og:image"
    content="https://alpha-dev.experizer.com/assets/images/dashboard/Trivia.jpg?0.48828660335873075" />
  <meta property="og:url" content="studio.experizer.com" />
  <meta property="og:description"
    content="IA dedicated space for learning a topic with Placeholders for  relevant infographics on side walls and an interactive Trivia infront. Customize the theme and the walls as per the topic of your Trivia." />

  <!-- For Twitter -->
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="Media Quiz" />
...
<body class="" id='mainBody'>
  ...
  <a-scene embeded shadow="type:pcfsoft" id="aScene" antialias="true" loading-screen="enabled:false">
    <a-assets>
      ...
      <video id="customVideo1" autoplay="false" loop="false" src="/act/v0.1/storypoint/assets/videos/test.mp4"
        crossorigin="anonymous" onended="westVideoEnd()"></video>
      <video id="customVideo2" autoplay="false" loop="false" src="/act/v0.1/storypoint/assets/videos/test.mp4"
        crossorigin="anonymous" onended="eastVideoEnd()"></video>
    ...
    <a-entity id="Table_lamp" obj-model="mtl:./assets/images/obj/table_lamp.mtl;obj:./assets/images/obj/table_lamp.obj"
      position="-7.310547841589662 -0.02891118556281952 -1.3984058042258816" rotation="0 -90 0" scale="0.3 0.3 0.3">
    </a-entity>
    <a-entity id="oldJug" obj-model="mtl:./assets/images/obj/old_jar.mtl;obj:./assets/images/obj/old_jar.obj"
      position="-7.199583779099295 0.2538698847168046 2.209038343314762" rotation="0 -90 0" scale="0.76 0.76 0.76">
    </a-entity>
    <a-entity id="table_2" obj-model="mtl:./assets/images/obj/tvStand.mtl;obj:./assets/images/obj/tvStand.obj"
      position="-7.053 -2.073 0.4158480469645802" rotation="0 90 0" scale="0.04 0.04 0.04"></a-entity>
    <a-entity id="lamp" obj-model="obj:url(./assets/images/living_lamp.obj);mtl:url(./assets/images/living_lamp.mtl);"
      position="6.229 -2.073 6.555" rotation="0 -90 0" scale="2.5 2.5 2.5"></a-entity>
    <a-entity id="lamp-2" obj-model="obj:./assets/images/living_lamp.obj;mtl:./assets/images/living_lamp.mtl"
      position="6.229 -2.073 -6.623279691595794" rotation="0 -90 0" scale="2.5 2.5 2.5"></a-entity>
    <a-entity id="sofa" obj-model="obj:./assets/images/sofa1.obj"
      material="metalness:0.6;src:./assets/images/pantalla_color.jpg" position="-1.630 -1.854 2.096" rotation="0 90 0"
      scale="0.015 0.020 0.020"></a-entity>
    <a-entity id="table" shadow="cast:true;receive:true"
      obj-model="mtl:./assets/images/table.mtl;obj:./assets/images/table.obj" position="1.944 -1.943 0.150"
      rotation="0 -90 0" scale="-0.024 0.022 0.022"></a-entity>
    <a-entity obj-model="obj:./assets/images/CubeRoom.obj" material="metalness:0.6;src:"
    ...
    <a-entity
      ...
      position="5.928290865401249 1.55 -6.017450637815735" rotation="-90 0 0" light-shadow="" visible=""></a-entity>
    <a-entity
      light="intensity:15;color:#ffffff;decay:10;distance:20;penumbra:1;type:spot;groundColor:#ffffff;angle:20;shadowCameraFar:1000"
      position="5.959 1.55 6.824" rotation="-90 0 0" light-shadow></a-entity>
    ...
    <a-entity id="mainScreen" position="1.758 -0.311 0">
      ...
      <a-entity id="1" position="200 200 200" rotation="0 -90 0" geometry="height:5;width:3.8" class="clickable"
        material="opacity:0;transparent:true;color:#FFFFFF" option-click="" sky="" scale="1.02 0.14 0.00001"></a-entity>
      ...
      <a-entity id="next" class="clickable" submit="" geometry="primitive:plane;width:1.5;height:0.5" rotation="0 -90 0"
        material="src:assets/images/next.png;opacity:0.99;shader:flat" sky="" position="20 20 20"></a-entity>
    ...
    <a-image visible="false" id="flex2" src="assets/images/score.png" geometry="height:3;width:6"
    position="6.75 1.0312388739393026 0.2309748624510259" rotation="0 90 0" scale="1.8 2 0.7" material=""></a-image>
    <!--ScoreScreen Start-->
    <a-entity id="scoreScreen" position="1.758412798271217 -0.311 0">
      <a-text visible="false" id="heading" value=""
        text="anchor:center;width:9;align:center;font:kelsonsans;height:5;tabSize:1;wrapCount:30"
        position="4.75 3.7002725225378312 0.053709460849015456" rotation="0 -90 0" visible=""></a-text>
      <a-text visible="false" id="subheading" value=""
        text="anchor:center;width:10;value:;font:kelsonsans;height:5;tabSize:1;align:center;wrapCount:60"
        position="4.75 2.94 0.05777866401694359" rotation="0 -90 0"></a-text>
      <a-text visible="false" id="endUserMsg" value="Thank you..!"
        ...
        position="4.75 -0.08653729362667995 -0.1656692412054599" rotation="0 -90 0"></a-text>
      <a-text visible="false" id="pointScreen" visible="" value="Thank you For the Quiz"
      ...
      <a-text visible="false" id="total2" value=""
        text="anchor:center;width:10;align:center;font:kelsonsans;height:5;tabSize:1"
        position="4.75 2.115 -0.18970303213011985" rotation="0 -90 0"></a-text>
      <a-text visible="false" id="total3" value=""
        text="anchor:center;width:10;align:center;font:kelsonsans;height:5;tabSize:1"
        position="4.75 1.594 0.10634100061154483" rotation="0 -90 0"></a-text>
      <a-text visible="false" id="total4" value=""
        text="anchor:center;width:8;value:=;align:center;font:kelsonsans;height:5;tabSize:1"
        position="4.75 1.721 -0.19394903082242146" rotation="0 -90 0" visible="false"></a-text>
      <a-text visible="false" id="total5" value="10"
      ...
      <a-entity visible="false" id="slash" position="4.75 1.886 0.005587378530517828"
    ...
    <a-image id="southLogo" class="clickable" mouseclick crossorigin="anonymous" src="./assets/images/default.jpg"
      width="4" height="3" geometry="" material="width:0;height:0" visible="" rotation="0 90 0"
      position="-7.819990525662335 5.041909205171174 -3.7255516165615816" scale="1 1 0.00001"></a-image>
    <a-image id="south_image2" class="clickable" mouseclick crossorigin="anonymous" src="./assets/images/default.jpg"
      width="4" height="3" geometry="" material="width:0;height:0" visible="" position="-7.903 2.590 1.814"
      rotation="0 90 0" scale="1 1 0.00001"></a-image>
    <!--East Wall Branding Start-->
    <a-image id="eastImage" class="clickable" mouseclick crossorigin="anonymous" src="assets/images/default.jpg"
      width="4" height="3" geometry="width:215;height:161" rotation="" material="width:0;height:0" visible=""
      position="-0.804526074332113 2.22 -7.357679047676627" scale="0.06 0.057 0.00001"></a-image>
    <a-image id="westImage" class="clickable" mouseclick crossorigin="anonymous" src="assets/images/default.jpg"
      width="4" height="3" geometry="width:215;height:161" rotation="0 180 0" material="width:0;height:0" visible=""
      position="-0.804526074332113 2.22 7.357679047676627" scale="0.06 0.057 0.00001"></a-image>
    <a-plane id="customeVideoPlane1" class="cursorEntry" visible="false" camera-pan-follow color="#CCC" width="16"
      height="9" position="-1.20989 1.9361 5.96129" scale="0.5 0.5 0.00001" rotation="0 180 0" material="" geometry="">
    </a-plane>
    <a-video id="video1" src="#customVideo1" autostart="false" width="25" height="15" position="2000 2000 2000"
      scale="0.3 0.3 0.00001" rotation="0 180 0" material="" geometry=""></a-video>

    <a-plane id="customeVideoPlane2" class="cursorEntry1" visible="false" camera-pan-follow-1 color="#CCC" width="16"
      height="9" position="-1.20989 1.9361 -5.96129" scale="0.5 0.5 0.00001" rotation="0 360 0" material="side: double"
      geometry=""></a-plane>
    <a-video id="video2" src="#customVideo2" width="25" height="15" position="2000 2000 2000" scale="0.3 0.3 0.00001"
      rotation="0 360 0" material="" geometry=""></a-video>
  </a-scene>
