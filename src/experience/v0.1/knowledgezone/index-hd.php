  ...
  <a-scene embeded shadow="type:pcfsoft" id="aScene" antialias="true" loading-screen="enabled:false">
    ...
    <a-entity id="mainScreen" position="1.758 -0.311 0">
      ...
      <a-entity id="option1" value=""
        ...
        visible="false" position="4.966 2.481 2.227" rotation="0 -90 0" sky="" scale=""></a-entity>
      <a-entity id="option2"
        text="anchor:center;width:4;tabSize:1;height:5;color:#fff;lineHeight:60;wrapCount:0;wrapPixels:900;baseline:top;value:option"
      ...
      <a-entity id="1" position="200 200 200" rotation="0 -90 0" geometry="primitive:plane;height:5;width:3.8"
        class="clickable" material="opacity:0;transparent:true;color:#FFFFFF" option-click="" sky=""
        scale="1.02 0.14 0.00001" ></a-entity>

      <a-entity id="2" position="200 200 200" rotation="0 -90 0" geometry="primitive:plane;height:5;width:3.8"
        class="clickable" material="opacity:0;transparent:true;color:#FFFFFF" option-click="" sky=""
        scale="1.02 0.14 0.00001" ></a-entity>

      <a-entity id="3" class="clickable" option-click="" position="200 200 200" rotation="0 -90 0"
        geometry="primitive:plane;height:5;width:3.8" material="opacity:0;transparent:true;color:#FFFFFF" sky=""
        scale="1.02 0.14 0.00001" crossorigin="anonymous" ></a-entity>

      <a-entity id="4" position="200 200 200" rotation="0 -90 0" geometry="primitive:plane;height:5;width:3.8"
        class="clickable" material="opacity:0;transparent:true;color:#FFFFFF" option-click="" sky=""
        scale="1.02 0.14 0.00001" ></a-entity>
    ...
    <a-entity id="proceed" class="clickable" geometry="primitive:plane;width:1.5;height:0.5" rotation="0 180 0"
    ...
    <a-image id="quizWallHeading" position="6.945 4.624 -3.84565" rotation="0 270 0" a-image="" scale="3 0.87 0.1">
    </a-image>
    <a-image id="scoreWallHeading" position="-7.82676 4.740 2.03197" rotation="0 90 0" a-image="" scale="3 0.87 0.18">
    </a-image>
    <a-image id="mediaWallHeading" position="-5.778 4.894 -7.440" rotation="" a-image="" scale="3 0.87 0.00001">
    </a-image>
