...
-->
  ...
  <link rel="stylesheet" href="/act/v0.1/walkaround/assets/css/bootstrap.min.css">
 ...
 <link rel="stylesheet" href="/act/v0.1/verbose/css/SplashScreenToogleButton.css">
  <script src="/act/v0.1/walkaround/assets/js/jquery-3.3.1.min.js"></script>
  <script src="/act/v0.1/walkaround/assets/js/bootstrap.min.js"></script>
  <script src="/act/v0.1/walkaround/assets/js/aframe-v1.0.4.js"></script>
  <script src="/act/v0.1/walkaround/assets/js/aframe-click-drag-component.min.js"></script>
  <script src="/act/v0.1/walkaround/assets/js/aframe-look-at-component.min.js"></script>
...
<body class="" id='mainBody'>
      ...
      animation__one="property: rotation;to: 0 360 0; dur: 2000;easing:easeInOutCirc;fill:forwards;repeat:0.5;loop:0;enabled:false"  >
            <a-entity id="CamEntity">
              ...
              <a-entity id="cursor" cursor="fuse: true; fuseTimeout: 1200"  raycaster="objects: .clickable" position="0 0 -1" sky scale="1 1 1" geometry="primitive: ring; radiusInner: 0.02; radiusOuter: 0.03"	material="color: red; shader: flat">
                <!-- <a-entity id="cursorImage" svgfile="svgFile:/act/v0.1/storypoint/assets/images/viewfinder.svg; width:0.012;opacity:1; "   position="-0.054 0.044 -0.014" material="shader: flat;"  light="type:ambient;intensity:1.71" scale="1 1 1"></a-entity> -->
              
              </a-entity>	
              </a-entity>
            </a-entity>
        </a-entity>
        <!-- <a-entity id="infoBox" visible="false" data-brackets-id="6449" obj-model="obj:assets/images/moonlight.obj" material="src:assets/images/tvscreenplane.jpg;side:double" position="-48.159 28.899 -82.059" look-at="src: #cameraId">   
  ...
  <script src="/act/v0.1/walkaround/assets/js/main.js"></script>
