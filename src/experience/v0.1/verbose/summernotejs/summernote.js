    ...
    return this.ui.buttonGroup({
      ...
      children: [this.button({
        ...
        data: {
         ...
         items: (foreColor ? ['<div class="note-palette">', '  <div>', '    <button type="button" class="note-color-reset btn btn-light" data-event="removeFormat" data-value="foreColor">', this.lang.color.resetToDefault, '    </button>', '  </div>', '  <div class="note-holder" data-event="foreColor"/>'].join('') : ''),
        callback: $dropdown => {
...
external_jQuery_default.a.summernote = external_jQuery_default.a.extend(external_jQuery_default.a.summernote, {
  ...
  options: {
    ...
    otherStaticBar: '',
    // toolbar
    toolbar: [['fontsize', ['fontsize']],['color', ['color']], ['fontname', ['fontname']], ['font', ['bold', 'italic','underline' ,'clear']], ['para', ['ul', 'ol', 'paragraph']]],
  
    // popover
    popatmouse: true,
    popover: {
      air: [['color', ['color']], ['font', ['bold', 'underline', 'clear']], ['para', ['ul', 'paragraph']] ]
    },
    ...
    fontNames: ['Arial', 'Arial Black', 'Comic Sans MS', 'Courier New', 'Helvetica Neue', 'Helvetica',  'Lucida Grande', 'Tahoma', 'Times New Roman', 'Verdana','Segoe UI','Roboto','Segoe UI Emoji','Segoe UI Symbol'],
    fontNamesIgnoreCheck: [],
    addDefaultFonts: true,
    fontSize: ['8', '9', '10', '11', '12', '14','16', '18','20', '24','28', '36'],
