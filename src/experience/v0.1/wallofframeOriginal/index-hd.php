...
-->
	...
	<!-- <script src="/act/v0.1/wallofframe/assets/js/aframe-extras.min.js"></script> -->
	...
	<!-- <script src="/act/v0.1/wallofframe/assets/js/aframe-animation-component.min.js"></script> -->
...
<body class="" id='mainBody'>
	...
	<a-scene embeded shadow="type:pcfsoft" id="aScene" loading-screen="enabled:false" antialias="true" physics="debug: true">
		...
		animation__one="property: rotation;to: 0 360 0; dur: 2000;easing:easeInOutCirc;enabled:false">
			<a-entity id="camera" camera position="0 1.6 0" look-controls="reverseTouchDrag:true">
				<a-entity id="cursorImage" position="0 0 -1" 
					geometry="primitive: ring; radiusInner: 0.02; radiusOuter: 0.03" material="color: red; shader: flat" cursor="fuse: true; fuseTimeout: 500"
					scale="0 0 0">
				</a-entity>
			</a-entity>
		...
		<a-assets>
			...
			<img id="floor-texture" src="/act/v0.1/wallofframe/assets/textures/Natural-floor.jpg">
			...
			<img id="hall-texture" src="/act/v0.1/wallofframe/assets/textures/Natural-hall.jpg">
