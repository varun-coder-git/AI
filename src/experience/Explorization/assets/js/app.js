...
function initializeCustomization(experienceToCustomize) {
	...
	//console.log(museum_data.gallery_data[i].buttonsArray);
	
	if(museum_data.gallery_data[i].buttonsArray==undefined)
	{
		var index=museum_data.gallery_data[0].length;
		var museum_temp=museum_data.gallery_data[i];
			//museum_temp[index]
			museum_temp[index="buttonsArray"]=	[
					{"button" : " ",
					"button_content":" ",
					"button_media":" "
					},
			...
			museum_data.gallery_data[i]=museum_temp;
		//	console.log("museumdata",museum_data);
...
$(document).ready(function () {
	$("#overlay").click(function () {
		...
		if (hallImageName != undefined && hallImageName != "")
		museum_data.hall_wall = hallImageName;	
		southImageName = "";
		northImageName = "";
		hallImageName ="";
	...
	init: function () {
		...
		this.el.addEventListener('click', function () {
			...
			if(museum_data.gallery_data[selectedFrame].buttonsArray[0].button=="" || museum_data.gallery_data[selectedFrame].buttonsArray[0].button==" ")
			{
				...
				document.getElementById("videoSkyPopup").style.display = option.value == "videoOption" ? "block" : "none";
			...
			else
			{
				if(museum_data.gallery_data[selectedFrame].buttonsArray[0].button_media=="Web")
				{
					...
					document.getElementById("videoSkyPopup").style.display = option.value == "videoOption" ? "block" : "none";
				document.getElementById("urlDisplay").style.display = option.value == "urlOption" ? "block" : "none";
					//document.getElementById("videoSkyPopup3").style.display = option.value == "videoOption3" ? "block" : "none";
			...
			if(museum_data.gallery_data[selectedFrame].buttonsArray[1].button=="" || museum_data.gallery_data[selectedFrame].buttonsArray[1].button==" ")
			{
				...
				document.getElementById("videoSkyPopup2").style.display = option.value == "videoOption2" ? "block" : "none";
			...
			else
			{
				...
				document.getElementById("urlDisplay3").style.display = option.value == "urlOption3" ? "block" : "none";
					//document.getElementById("videoSkyPopup3").style.display = option.value == "videoOption3" ? "block" : "none";
						...
						if(museum_data.gallery_data[selectedFrame].buttonsArray[3].button=="" || museum_data.gallery_data[selectedFrame].buttonsArray[3].button==" ")
						{
							option.value="noneOption4";
							document.getElementById("customLabelVideo4").innerHTML="Choose Video";
							document.getElementById("urlname4").value="";
							
							document.getElementById("videoSkyPopup4").style.display = option.value == "videoOption4" ? "block" : "none";
							document.getElementById("urlDisplay4").style.display = option.value == "urlOption4" ? "block" : "none";
						}
						else
						{
							if(museum_data.gallery_data[selectedFrame].buttonsArray[3].button_media=="Web")
							{
								option.value="urlOption4";
								document.getElementById("urlname4").value=museum_data.gallery_data[selectedFrame].buttonsArray[3].button_content;
								document.getElementById("videoSkyPopup4").style.display = option.value == "videoOption4" ? "block" : "none";
							document.getElementById("urlDisplay4").style.display = option.value == "urlOption4" ? "block" : "none";
								//document.getElementById("videoSkyPopup3").style.display = option.value == "videoOption3" ? "block" : "none";
								
							}
							else if(museum_data.gallery_data[selectedFrame].buttonsArray[3].button_media=="Video")
							{
								option.value="videoOption4";
								var temp_v=document.getElementById("customLabelVideo4").value=museum_data.gallery_data[selectedFrame].buttonsArray[3].button_content;
								var result=temp_v.split("/");
								document.getElementById("customLabelVideo4").innerHTML=result[result.length-1];
								document.getElementById("videoSkyPopup4").style.display = option.value == "videoOption4" ? "block" : "none";
							document.getElementById("urlDisplay4").style.display = option.value == "urlOption4" ? "block" : "none";
								//document.getElementById("videoSkyPopup3").style.display = option.value == "videoOption3" ? "block" : "none";
							}
			...
			if(museum_data.gallery_data[selectedFrame].buttonsArray[4].button=="" || museum_data.gallery_data[selectedFrame].buttonsArray[4].button==" ")
			{
				option.value="noneOption5";
				document.getElementById("customLabelVideo5").innerHTML="Choose Video";
				document.getElementById("urlname5").value="";
				
				document.getElementById("videoSkyPopup5").style.display = option.value == "videoOption5" ? "block" : "none";
				document.getElementById("urlDisplay5").style.display = option.value == "urlOption5" ? "block" : "none";
			}
			else
			{
				if(museum_data.gallery_data[selectedFrame].buttonsArray[4].button_media=="Web")
				{
					option.value="urlOption5";
					document.getElementById("urlname5").value=museum_data.gallery_data[selectedFrame].buttonsArray[4].button_content;
					document.getElementById("videoSkyPopup5").style.display = option.value == "videoOption5" ? "block" : "none";
				document.getElementById("urlDisplay5").style.display = option.value == "urlOption5" ? "block" : "none";
					//document.getElementById("videoSkyPopup3").style.display = option.value == "videoOption3" ? "block" : "none";
					
				}
				else if(museum_data.gallery_data[selectedFrame].buttonsArray[4].button_media=="Video")
				{
					option.value="videoOption5";
					var temp_v=document.getElementById("customLabelVideo5").value=museum_data.gallery_data[selectedFrame].buttonsArray[4].button_content;
					var result=temp_v.split("/");
					document.getElementById("customLabelVideo5").innerHTML=result[result.length-1];
					document.getElementById("videoSkyPopup5").style.display = option.value == "videoOption5" ? "block" : "none";
				document.getElementById("urlDisplay5").style.display = option.value == "urlOption5" ? "block" : "none";
					//document.getElementById("videoSkyPopup3").style.display = option.value == "videoOption3" ? "block" : "none";
				}
...
var southImage = "";
var southImageName = "";
var videoIconsMediaButton="";
var imageIconsMediaButton="";
var urlIconsMediaButton="";
...
var northImageName = "";
var hallImageName ="";
var centerFloorImageName="";
var audioFile = "";
var audioFileName = "";
var splashImagePath = "";
var selectedFrame = "";
var selectedDecoreoption = "";
var selectedFloor="";
...
function decoreOptionChanged(option) {
	...
	if(regEx.test(option)){
		halltexture.setAttribute('material', 'src:' + selectedDecoreoption );
	}
	else{
	...
	museum_data.decore_option = selectedDecoreoption;
	museum_data.centerFloor=null;
	museum_data.frontFloor=null;
	museum_data.backFloor=null;
	museum_data.isHallUploaded=0;
	
}

function decoreOptionChangedHall(hallOption){
	hallOptionUploaded = hallOption;
	var halltexture = document.querySelector('#hall');
	halltexture.setAttribute('material', 'src:' + hallOptionUploaded );
	museum_data.decore_option_hall = hallOptionUploaded;
	museum_data.isHallUploaded=1;
}



function decoreOptionChangedFloor(floorOption,side){
	selectedFloor = floorOption;
	if(side=="centerFloor"){
	var floortexture = document.querySelector('#floor');
	floortexture.setAttribute('material', 'src:' + selectedFloor);
	museum_data.centerFloor = selectedFloor;
	}
	else if(side=="frontFloor"){
		var floortexture = document.querySelector('#floor2');
		floortexture.setAttribute('material', 'src:' + selectedFloor);
		museum_data.frontFloor = selectedFloor;
	}
	else if(side=="backFloor"){
		var floortexture = document.querySelector('#floor3');
		floortexture.setAttribute('material', 'src:' + selectedFloor);
		museum_data.backFloor = selectedFloor;
	}	
	selectedDecoreoption = museum_data.decore_option;
}

function decoreOptionRender(option){
//	selectedDecoreoption = option;
	var halltexture = document.querySelector('#hall');
	const regEx = /^https/;
	if(option){
	...
	selectedDecoreoption= museum_data.decore_option;
	 museum_data.decore_option_hall=museum_data.decore_option_hall;
}
	...
	if (assetPath != "") {
		...
		else if(imageLocation=="MediaType1")
		{
			...
			gallery_entity.setAttribute('material', 'src: #changedgallery');
					...
					var ImageInputLabel = document.getElementById('customLabelImage');
					ImageInputLabel.innerText = imageFileName;
					finalGlobalData.VideoSrc = VideoPath;
					galleryImageName = assetPath;
		...
		else if(imageLocation=="MediaType2")
		{
			...
			gallery_entity.setAttribute('material', 'src: #changedgallery');
					...
					var ImageInputLabel = document.getElementById('customLabelImage2');
					ImageInputLabel.innerText = imageFileName;
					finalGlobalData.VideoSrc = VideoPath;
					galleryImageName = assetPath;
		...
		else if(imageLocation=="MediaType3")
		{
				...
				if(assettype == 'Image'){
					...
					var ImageInputLabel = document.getElementById('customLabelImage3');
					ImageInputLabel.innerText = imageFileName;
					finalGlobalData.VideoSrc = VideoPath;
					galleryImageName = assetPath;
				}
		}
		else if(imageLocation=="MediaType4"){
			assetspath = assetPath;
			var selectedFrame = document.getElementById("frameDropDown").selectedIndex;

			museum_data.gallery_data[selectedFrame].buttonsArray[3].button_content=assetspath;
			//console.log(buttonsArray[2]);
			museum_data;
			if (assettype == 'Video') {
			  VideoPath = assetspath;
			  ...
			  var VideoInputLabel = document.getElementById('customLabelVideo4');
			  VideoInputLabel.innerText = videoFileName;
			  finalGlobalData.VideoSrc = VideoPath;
			}
			if(assettype == 'Image'){
				...
				var ImageInputLabel = document.getElementById('customLabelImage4');
				ImageInputLabel.innerText = imageFileName;
				finalGlobalData.VideoSrc = VideoPath;
				galleryImageName = assetPath;
			}
		}
		else if(imageLocation=="MediaType5"){
			assetspath = assetPath;
			var selectedFrame = document.getElementById("frameDropDown").selectedIndex;

			museum_data.gallery_data[selectedFrame].buttonsArray[4].button_content=assetspath;
			//console.log(buttonsArray[2]);
			museum_data;
			if (assettype == 'Video') {
			  VideoPath = assetspath;
			  ...
			  var VideoInputLabel = document.getElementById('customLabelVideo5');
			  VideoInputLabel.innerText = videoFileName;
			  finalGlobalData.VideoSrc = VideoPath;
			}
			if(assettype == 'Image'){
				...
				var ImageInputLabel = document.getElementById('customLabelImage5');
				ImageInputLabel.innerText = imageFileName;
				finalGlobalData.VideoSrc = VideoPath;
				galleryImageName = assetPath;
			}
		}
		else if(imageLocation=="Hall"){
			hallImageName = assetPath;
		
			//museum_data.hall_wall=assetPath
			$('#customHallLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
			decoreOptionChangedHall(assetPath);
		//	var halltexture = document.querySelector('#hall');
		//	halltexture.setAttribute('material', 'src:'+hallImageName);
		}
		else if(imageLocation=="centerFloor"){
			centerFloorImageName = assetPath;
			$('#centerFloorLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
		//	decoreOptionChanged(assetPath);
		decoreOptionChangedFloor(assetPath,"centerFloor");
		//	floortexture.setAttribute('material', 'src:'+centerFloorImageName);
		//	halltexture.setAttribute('material', 'src:'+hallImageName);

		}
		else if(imageLocation=="frontFloor"){
			centerFloorImageName = assetPath;
			$('#frontFloorLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
		//	decoreOptionChanged(assetPath);
		decoreOptionChangedFloor(assetPath,"frontFloor");
		//	floortexture.setAttribute('material', 'src:'+centerFloorImageName);
		//	halltexture.setAttribute('material', 'src:'+hallImageName);

		}
		else if(imageLocation=="backFloor"){
			centerFloorImageName = assetPath;
			$('#backFloorLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
		//	decoreOptionChanged(assetPath);
		decoreOptionChangedFloor(assetPath,"backFloor");
		//	floortexture.setAttribute('material', 'src:'+centerFloorImageName);
		//	halltexture.setAttribute('material', 'src:'+hallImageName);

		}
		else if(imageLocation=="VideoIconsMediaButton"){
		videoIconsMediaButton = assetPath;
		museum_data.videoPlayIcon=assetPath;
		$('#customVideoIconsLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
		for (i = 1; i <= museum_data.gallery_data.length; i++) {
			for (j = 1; j <= museum_data.gallery_data[i - 1].buttonsArray.length; j++) {
				if(museum_data.gallery_data[i - 1].buttonsArray[j - 1].button_media=="Video"){
					museum_data.gallery_data[i - 1].buttonsArray[j - 1].button=assetPath;
					var frameButtonConcat="button-"+(j)+"-frame-"+(i);
					var frameButton=document.getElementById(frameButtonConcat);
					frameButton.setAttribute("material", "src: "+assetPath+"; opacity:0.9;");    
				}
			}
		}
		}
		else if(imageLocation=="VideoPauseIconsMediaButton"){
		//videoPauseIconsMediaButton	=assetPath;
		$('#customVideoPauseIconsLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
		museum_data.pauseMediaButton=assetPath;
		}
		else if(imageLocation=="URLIconsMediaButton"){
		urlIconsMediaButton = assetPath;
		museum_data.webIcon=assetPath;
		$('#customURLIconsLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
		for (i = 1; i <= museum_data.gallery_data.length; i++) {
			for (j = 1; j <= museum_data.gallery_data[i - 1].buttonsArray.length; j++) {
				if(museum_data.gallery_data[i - 1].buttonsArray[j - 1].button_media=="Web"){
					museum_data.gallery_data[i - 1].buttonsArray[j - 1].button=assetPath;
					var frameButtonConcat="button-"+(j)+"-frame-"+(i);
					var frameButton=document.getElementById(frameButtonConcat);
					frameButton.setAttribute("material", "src: "+assetPath+"; opacity:0.9;");    
		...
		else if(imageLocation=="ImageIconsMediaButton"){
		imageIconsMediaButton = assetPath;
		museum_data.imageIcon=assetPath;
		$('#customImageIconsLabelImage').text(assetPath.split("/")[assetPath.split("/").length - 1]);
		for (i = 1; i <= museum_data.gallery_data.length; i++) {
			for (j = 1; j <= museum_data.gallery_data[i - 1].buttonsArray.length; j++) {
				if(museum_data.gallery_data[i - 1].buttonsArray[j - 1].button_media=="Image"){
					museum_data.gallery_data[i - 1].buttonsArray[j - 1].button=assetPath;
					var frameButtonConcat="button-"+(j)+"-frame-"+(i);
					var frameButton=document.getElementById(frameButtonConcat);
					frameButton.setAttribute("material", "src: "+assetPath+"; opacity:0.9;");    
...
function VideoName(type, imagetype) {
	assettype = type;
	if (type == 'Image')
...
function ImageMediaName(type,mediatypeNO){
	assettype = type;
	// if (type == 'Image')
	//   icustommageType = imagetype;
	imageLocation=mediatypeNO;

	window.parent.triggerAssetsPopup();
}  

// function VideoMediaName(type, imagetype) {
// 	assettype = type;
// 	if (type == 'Image')
// 	  icustommageType = imagetype;
// 	imageLocation="MediaType1";
...
function customSkyImage2(type, event) {
	assettype = type;
	assetId = event.id;
  ...
  function VideoName2(type, imagetype) {
	  assettype = type;
	  if (type == 'Image')
		icustommageType = imagetype;
	  imageLocation="MediaType2";
...
function customSkyImage3(type, event) {
		assettype = type;
		assetId = event.id;
	...
	function VideoName3(type, imagetype) {
		assettype = type;
		if (type == 'Image')
			icustommageType = imagetype;
		imageLocation="MediaType3";
...
function renderExperience(experienceData) {
	...
	decoreOptionRender(experienceData.isHallUploaded);
	if(experienceData.centerFloor){
		decoreOptionChangedFloor(experienceData.centerFloor,"centerFloor");
	}
	else{
		var floortexture = document.querySelector('#floor');
	floortexture.setAttribute('material', 'src: assets/textures/' + experienceData.decore_option + '-floor.jpg');
	}
	if(experienceData.frontFloor){
		decoreOptionChangedFloor(experienceData.frontFloor,"frontFloor");
	}
	else{
		var floortexture = document.querySelector('#floor2');
	floortexture.setAttribute('material', 'src: assets/textures/' + experienceData.decore_option + '-floor.jpg');
	}
		if(experienceData.backFloor){
		decoreOptionChangedFloor(experienceData.backFloor,"backFloor");
	}
	else{
		var floortexture = document.querySelector('#floor3');
	floortexture.setAttribute('material', 'src: assets/textures/' + experienceData.decore_option + '-floor.jpg');
...
//	decoreOptionChanged(experienceData.decore_option);
	...
	var north_wall = document.querySelector('#image-North-wall');
	var hall_wall = document.querySelector('#hall');
	...
	// if (experienceData.hall_wall != "")
	// $('#customHallLabelImage').text(experienceData.hall_wall.split("/")[experienceData.hall.split("/").length - 1]);	
	var south_wall = document.querySelector('#image-South-wall');
	...
	for (var i = 0; i <museum_data.gallery_data.length; i++) {
		...
		if(experienceData.gallery_data[i].buttonsArray[3].button!=" " && experienceData.gallery_data[i].buttonsArray[3].button!="")
		{	
		var button=document.getElementById(str4);
		button.setAttribute("material", "src: "+experienceData.gallery_data[i].buttonsArray[3].button+"; opacity:0.9;");    
		button.setAttribute("visible", "true");
		}
		else{	
		var button=document.getElementById(str4);
		...
		if(experienceData.gallery_data[i].buttonsArray[4].button!=" " && experienceData.gallery_data[i].buttonsArray[4].button!="")
		{	
		var button=document.getElementById(str5);
		button.setAttribute("material", "src: "+experienceData.gallery_data[i].buttonsArray[4].button+"; opacity:0.9;");    
		button.setAttribute("visible", "true");
		}
		else{	
		var button=document.getElementById(str5);
...
function popSnackbar(type, message) {
 ...
 $('.maxContentPost').summernote({
	...
	const regExDrop = /^https/;
	function DropdownList() 
	{
		var path="assets/images/";
		var option1 =document.getElementById("option1");
		var video=document.getElementById("videoSkyPopup");
		var url=document.getElementById("urlDisplay");
		var imageMedia=document.getElementById("imageMediaPopup");
		video.style.display = option1.value == "videoOption" ? "block" : "none";
		url.style.display = option1.value == "urlOption" ? "block" : "none";
		imageMedia.style.display = option1.value == "imageOption" ? "block" : "none";
		var selectedFrame = document.getElementById("frameDropDown").selectedIndex;

	//museum_data.gallery_data[selectedFrame].buttonsArray[0].button_content;
	
		if(option1.value=="urlOption")
		{
			if(regExDrop.test(museum_data.webIcon)){
				path=museum_data.webIcon;
		  }
		  else{
		...
		{
			if(regExDrop.test(museum_data.videoPlayIcon)){
				path=museum_data.videoPlayIcon;
		  }
		  else{
		...
		else if(option1.value=="imageOption"){
			
			if(regExDrop.test(museum_data.imageIcon)){
				path=museum_data.imageIcon;
		  }
		  else{
			path=path.concat("play3.jpg");
		  }
			museum_data.gallery_data[selectedFrame].buttonsArray[0].button_media="Image";
				document.getElementById("urlname1").value="";
		}
	...
	//	console.log(museum_data.gallery_data[selectedFrame].buttonsArray[0].button_content);
		...
		button.setAttribute("visible", "true");
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[0].button_media="";
			museum_data.gallery_data[selectedFrame].buttonsArray[0].button_content="";
			document.getElementById("customLabelVideo").innerHTML="Choose Video";
			document.getElementById("customLabelImage").innerHTML="Choose Image";
				document.getElementById("urlname1").value="";
			var str="button-1-frame-";
			str=str.concat(selectedFrame+1);
		var button=document.getElementById(str);
	...
	function DropdownList2() 
	{
		...
		var video=document.getElementById("videoSkyPopup2");
		var url=document.getElementById("urlDisplay2");
		var imageMedia=document.getElementById("imageMediaPopup2");
		video.style.display = option2.value == "videoOption2" ? "block" : "none";
		url.style.display = option2.value == "urlOption2" ? "block" : "none";
		imageMedia.style.display = option2.value == "imageOption2" ? "block" : "none";
		...
		else if(option2.value=="videoOption2")
		{
		...
		else if(option2.value=="imageOption2"){
			if(regExDrop.test(museum_data.imageIcon)){
				path=museum_data.imageIcon;
		  }
		  else{
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[1].button_media="Image";
				document.getElementById("urlname2").value="";
		}
	...
	//	console.log(museum_data.gallery_data[selectedFrame].buttonsArray[1].button_content);
		...
		button.setAttribute("visible", "true");
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[1].button_media="";
			museum_data.gallery_data[selectedFrame].buttonsArray[1].button_content="";
			document.getElementById("customLabelVideo2").innerHTML="Choose Video";
			document.getElementById("customLabelImage2").innerHTML="Choose Image";
				document.getElementById("urlname2").value="";
			var str="button-2-frame-";
			str=str.concat(selectedFrame+1);
		var button=document.getElementById(str);
	...
	function DropdownList3() 
	{
		var path="assets/images/";
		var option =document.getElementById("option3");
		var video=document.getElementById("videoSkyPopup3")
		var url=document.getElementById("urlDisplay3")
		var imageMedia=document.getElementById("imageMediaPopup3");
		video.style.display = option.value == "videoOption3" ? "block" : "none";
		url.style.display = option.value == "urlOption3" ? "block" : "none";
		imageMedia.style.display = option.value == "imageOption3" ? "block" : "none";
		var selectedFrame = document.getElementById("frameDropDown").selectedIndex;
		...
		else if(option.value=="videoOption3")
		{
		...
		else if(option.value=="imageOption3"){
			if(regExDrop.test(museum_data.imageIcon)){
				path=museum_data.imageIcon;
		  }
		  else{
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[2].button_media="Image";
				document.getElementById("urlname3").value="";
		}
		...
		var button=document.getElementById(str);
		//console.log(museum_data.gallery_data[selectedFrame].buttonsArray[0].button);
	//	console.log(museum_data.gallery_data[selectedFrame].buttonsArray[2].button_content);
		...
		button.setAttribute("visible", "true");
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[2].button_media="";
			museum_data.gallery_data[selectedFrame].buttonsArray[2].button_content="";		
			document.getElementById("customLabelVideo3").innerHTML="Choose Video";
			document.getElementById("customLabelImage3").innerHTML="Choose Image";
				document.getElementById("urlname3").value="";	
			var str="button-3-frame-";
			str=str.concat(selectedFrame+1);
		var button=document.getElementById(str);
	...
	function DropdownList4() 
	{
		var path="assets/images/";
		var option =document.getElementById("option4");
		var video=document.getElementById("videoSkyPopup4")
		var url=document.getElementById("urlDisplay4")
		var imageMedia=document.getElementById("imageMediaPopup4");
		video.style.display = option.value == "videoOption4" ? "block" : "none";
		url.style.display = option.value == "urlOption4" ? "block" : "none";
		imageMedia.style.display = option.value == "imageOption4" ? "block" : "none";
		var selectedFrame = document.getElementById("frameDropDown").selectedIndex;

		if(option.value=="urlOption4")
		{
			if(regExDrop.test(museum_data.webIcon)){
				path=museum_data.webIcon;
		  }
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[3].button_media="Web";
				document.getElementById("urlname4").value="";


		}
		else if(option.value=="videoOption4")
		{
			if(regExDrop.test(museum_data.videoPlayIcon)){
				path=museum_data.videoPlayIcon;
		  }
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[3].button_media="Video";
				document.getElementById("urlname4").value="";
		}
		else if(option.value=="imageOption4"){
			if(regExDrop.test(museum_data.imageIcon)){
				path=museum_data.imageIcon;
		  }
		  else{
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[3].button_media="Image";
				document.getElementById("urlname4").value="";
		}
		if(option.value!="noneOption4")
		{
			museum_data.gallery_data[selectedFrame].buttonsArray[3].button=path;
			var str="button-4-frame-";
			str=str.concat(selectedFrame+1);
		var button=document.getElementById(str);
		//console.log(museum_data.gallery_data[selectedFrame].buttonsArray[0].button);
	//	console.log(museum_data.gallery_data[selectedFrame].buttonsArray[3].button_content);
		button.setAttribute("material", "src: "+museum_data.gallery_data[selectedFrame].buttonsArray[3].button+"; opacity:0.9;");    
		button.setAttribute("visible", "true");
		}
		else{
			museum_data.gallery_data[selectedFrame].buttonsArray[3].button="";
			museum_data.gallery_data[selectedFrame].buttonsArray[3].button_media="";
			museum_data.gallery_data[selectedFrame].buttonsArray[3].button_content="";		
			document.getElementById("customLabelVideo4").innerHTML="Choose Video";
			document.getElementById("customLabelImage4").innerHTML="Choose Image";
				document.getElementById("urlname3").value="";	
			var str="button-4-frame-";
			str=str.concat(selectedFrame+1);
		var button=document.getElementById(str);
	...
	function DropdownList5() 
	{
		var path="assets/images/";
		var option =document.getElementById("option5");
		var video=document.getElementById("videoSkyPopup5")
		var url=document.getElementById("urlDisplay5")
		var imageMedia=document.getElementById("imageMediaPopup5");
		video.style.display = option.value == "videoOption5" ? "block" : "none";
		url.style.display = option.value == "urlOption5" ? "block" : "none";
		imageMedia.style.display = option.value == "imageOption5" ? "block" : "none";
		var selectedFrame = document.getElementById("frameDropDown").selectedIndex;

		if(option.value=="urlOption5")
		{
			if(regExDrop.test(museum_data.webIcon)){
				path=museum_data.webIcon;
		  }
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[4].button_media="Web";
				document.getElementById("urlname4").value="";


		}
		else if(option.value=="videoOption5")
		{
			if(regExDrop.test(museum_data.videoPlayIcon)){
				path=museum_data.videoPlayIcon;
		  }
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[4].button_media="Video";
				document.getElementById("urlname5").value="";
		}
		else if(option.value=="imageOption5"){
			if(regExDrop.test(museum_data.imageIcon)){
				path=museum_data.imageIcon;
		  }
		  else{
			...
			museum_data.gallery_data[selectedFrame].buttonsArray[4].button_media="Image";
				document.getElementById("urlname5").value="";
		}
		if(option.value!="noneOption5")
		{
			museum_data.gallery_data[selectedFrame].buttonsArray[4].button=path;
			var str="button-5-frame-";
			str=str.concat(selectedFrame+1);
		var button=document.getElementById(str);
		//console.log(museum_data.gallery_data[selectedFrame].buttonsArray[0].button);
	//	console.log(museum_data.gallery_data[selectedFrame].buttonsArray[4].button_content);
		button.setAttribute("material", "src: "+museum_data.gallery_data[selectedFrame].buttonsArray[4].button+"; opacity:0.9;");    
		button.setAttribute("visible", "true");
		}
		else{
			museum_data.gallery_data[selectedFrame].buttonsArray[4].button="";
			museum_data.gallery_data[selectedFrame].buttonsArray[4].button_media="";
			museum_data.gallery_data[selectedFrame].buttonsArray[4].button_content="";		
			document.getElementById("customLabelVideo5").innerHTML="Choose Video";
			document.getElementById("customLabelImage5").innerHTML="Choose Image";
				document.getElementById("urlname5").value="";	
			var str="button-5-frame-";
			str=str.concat(selectedFrame+1);
		var button=document.getElementById(str);
...
function urlName4()
{
	var urlname=document.getElementById("urlname4").value;
	var selectedFrame = document.getElementById("frameDropDown").selectedIndex;
	museum_data.gallery_data[selectedFrame].buttonsArray[3].button_content=urlname;
	
}
function urlName5()
{
	var urlname=document.getElementById("urlname5").value;
	var selectedFrame = document.getElementById("frameDropDown").selectedIndex;
	museum_data.gallery_data[selectedFrame].buttonsArray[4].button_content=urlname;
